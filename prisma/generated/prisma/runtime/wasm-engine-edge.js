...
function ot(t, e) {
  ...
  if (
    ...
    return (
      ...
      (R = ot(new O(n + "." + r.slice(1)), h - k).plus(f)),
      (O.precision = D),
      e == null ? ((q = !0), L(R, D)) : R
    );
  for (
...
function L(t, e, r) {
          ...
          : a > 5 ||
            (a == 5 &&
              (r == 4 ||
                f ||
                (r == 6 &&
                  ((n > 0 ? (i > 0 ? h / Oe(10, s - i) : 0) : A[C - 1]) % 10) &
                    1) ||
                r == (t.s < 0 ? 8 : 7))))),
    e < 1 || !A[0])
  )
  ...
  if (
    (n == 0
      ...
      : ((A.length = C + 1),
        (o = Oe(10, N - n)),
        (A[C] = i > 0 ? (((h / Oe(10, s - i)) % Oe(10, i)) | 0) * o : 0)),
    f)
  )
    for (;;)
      if (C == 0) {
...
var gs = {
  enabled:
    !Cn && An == null && Rn !== "dumb" && ((Sr != null && Sr !== "0") || Sn),
};
function U(t, e) {
...
function Ze(t = {}) {
  ...
  return Object.entries(e).reduce(
    (n, [i, o]) => (
      ji[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n
    ),
    { select: {} },
  );
}
...
var hl = () => globalThis.process?.release?.name === "node",
  ...
  wl = () => !!globalThis.Deno,
  El = () => typeof globalThis.Netlify == "object",
  xl = () => typeof globalThis.EdgeRuntime == "object",
        ...
        (this.dataloader = new hr({
          batchLoader: ao(async ({ requests: n, customDataProxyFetch: i }) => {
            let { transaction: o, otelParentCtx: s } = n[0],
              ...
              h = n.some((A) => cn(A.protocolQuery.action));
            return (
